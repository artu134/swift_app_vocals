...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    // Assume you have an array of available camera types
        let cameraTypes = ["Front", "Back", "Wide", "Telephoto"]
        ...
        func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
            // Handle the selection of a camera type here
            print("Selected camera: \(cameraTypes[row])")
        }
    ...
    var segmentationService: SegmentsService!
